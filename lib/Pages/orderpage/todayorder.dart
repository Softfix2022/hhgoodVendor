  ...
  Container buildPrintRow(
    ...
    return Container(
      ...
      child: Align(
        ...
        },color: kMainColor,child: Text(locale.printinvoice),textColor: kWhiteColor,),
      ),
    );
  }
          ...
          Align(
            ...
            child: ClipRRect(
              ...
              child: RaisedButton(
                ...
                _onConnect();
              },child: Text(locale.connect),color: kMainColor,textColor: kWhiteColor,),
            ),
          ),
        ],
      ),
